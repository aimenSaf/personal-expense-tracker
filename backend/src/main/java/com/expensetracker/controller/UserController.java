...
import com.expensetracker.dto.RegisterRequest;  //DTO that holds incoming registration data
import com.expensetracker.model.User;   //JPA entity class representing the db user table
import com.expensetracker.service.UserService;   //service class that contains the actual registration logic
